...
import { aboutFocusCards } from '../../data/siteConfig.js'
import './About.css'
      ...
      <div className="about-inner">
        ...
        <div className="about-layout">
          ...
          <div className="about-content">
            <div className="about-panel">
              ...
              <p>
                Outside of work I play chess and explore new tools — including AI-assisted workflows with Cursor and
                Claude — which keeps me thinking strategically and adapting quickly. I am currently employed full time,
                and I still love meeting other builders, exchanging ideas, and staying curious about what is next on the
                web.
              </p>
            </div>
          </div>
        ...
        <div className="about-spotlights" aria-labelledby="about-spotlights-title">
          ...
          <ul className="about-spotlight-grid">
            {aboutFocusCards.map((card, index) => (
